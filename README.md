...
#### 📊 [Report Service](https://github.com) — Сервис генерации отчетов
...
#### 📈 [crypto_price_tracker](https://github.com) — Асинхронный сервис мониторинга цен 
...
#### 🏨 [Hotel API](https://github.com) — Система бронирования с кэшированием
